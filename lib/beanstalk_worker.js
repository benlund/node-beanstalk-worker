(function(){
  ...
  BeanstalkWorker.prototype.start = function(options) {
    !(typeof options !== "undefined" && options !== null) ? (options = {}) : null;
    this.log('Starting...');
    ...
    return client.connect(this.server, __bind(function(err, conn) {
        if (err) {
          ...
          return this.watch_tubes(options.tubes, __bind(function() {
              var ignored;
              ignored = [];
              options.ignore_default ? ignored.push('default') : null;
